...
<body>
    ...
    if (isset($_POST["lupa"])) {
        ...
        $ambil = $koneksi->query("SELECT * FROM pembeli WHERE email = '$email' AND telepon = 
            '$telepon'");
        ...
        if ($akunyangcocok == 1) {
            ...
            // anda gagal login
            echo "<script>alert('Email atau no telpon belum terdaftar, Mohon Periksa Kembali Akun Anda');</script>";
            echo "<script>location='lupapw.php';</script>";
        }
    }
    ?>
    <!-- END LOGIN PEMBELI -->
