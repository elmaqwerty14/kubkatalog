...
<body>
    ...
    <div class="form-box">
        ...
        <form action="" method="POST">
            ...
            <center style="font-size: 12px;"><a href="lupapw.php" class="animated zoomIn" style="animation-delay: 1.9s;">Lupa Password</a></center><br>
            <center style="font-size: 12px; margin-top: 0px;">Belum punya akun?<a href="dpcoba.php" class="animated zoomIn" style="animation-delay: 1.9s;">Signup Now</a></center>
        </form>
    </div>
