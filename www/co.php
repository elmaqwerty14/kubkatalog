            ...
            <div class="col-12">
                ...
                <form action="" method="POST" class="mb-4">
                    ...
                    <div class="form-group row align-middle">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="provinsi"  style="font-size: 13px; cursor: no-drop;" readonly value="<?php echo ($_SESSION["pembeli"]['provinsi'])?>" class="form-control">
                        </div>
                        ...
                        <div class="col-md-5">
                            <input type="text" name="distrik" style="font-size: 13px; cursor: no-drop;" readonly value="<?php echo ($_SESSION["pembeli"]['distrik'])?>" class="form-control">
                        </div>

                        <input type="number" name="idd" value="<?php echo ($_SESSION["pembeli"]['idd'])?>" hidden>
                    ...
                    <input type="text" name="provinsi" value="<?php echo ($_SESSION["pembeli"]['provinsi'])?>" hidden>
                    <input type="text" name="distrik" value="<?php echo ($_SESSION["pembeli"]['distrik'])?>" hidden>
                    <input type="text" name="tipe" value="<?php echo ($_SESSION["pembeli"]['tipe'])?>" hidden>
                    <input type="text" name="kodepos" value="<?php echo ($_SESSION["pembeli"]['kodepos'])?>" hidden>
                    <input type="text" name="ekspedisi" hidden required>
                    <input type="text" name="paket" hidden required>
                    <!-- <input type="text" name="ongkir" id="ongkir" hidden> -->
                    <input type="text" name="estimasi" hidden required>
        ...
        <div class="row row-checkout">
            <div class="col-12">
                ...
                <form action="" method="POST" class="mb-4">
                    ...
                    <input  
                    type="hidden"
                    name="total_belanja" value="<?php echo strval($totalbelanja); ?>" /required>
                    
                     <?php $finaltotalbelanja = $totalbelanja + $ongkir; ?>


                    <input type="text" name="ongkirbeli" hidden required>
                    
                    <input type="text" name="finaltotalbelanjabeli" hidden required><tr>
            ...
            <?php
                if (isset($_POST["bayar_sekarang"])) {
                    ...
                    $tgl_expired = date("Y-m-d H:i:s", strtotime('+3 day', strtotime($tgl_pembelian))); // Tanggal kadaluarsa (3 hari setelah tanggal pembelian)
