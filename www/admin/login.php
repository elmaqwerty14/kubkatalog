...
<body>
    <div class="container-scroller">
        <div class="container-fluid page-body-wrapper full-page-wrapper">
            <div class="content-wrapper d-flex align-items-center auth" style="background-image: url(assets/images/dashboard/loginadmin.jpg); background-size: cover; width: 100%; height: 100vh;">
                        ...
                        <div class="auth-form-light text-left p-5" style="background: #ffffffb8; box-shadow: 0 1rem 9rem rgb(249 169 23 / 32%) !important;">
                            ...
                            <form method="POST" class="pt-3">
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Email" required="" autocomplete="off" name="email">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="my-2 d-flex justify-content-between align-items-center">
                                    <div class="form-check">
                                        <label class="form-check-label text-muted" style="color: #3E4B5B !important;">
                                            <input type="checkbox" class="form-check-input" required> Saya Adalah Admin KUB Merci
                                        </label>
                                    </div>
                                </div>
                                <div class="mt-3">
                                ...
                                <!-- <div class="text-center mt-4" style="font-size: 14px; color: #3E4B5B;"> Belum punya akun? <a href="#" class="text-primary">Signup</a>
                                </div> -->
                            </form>
