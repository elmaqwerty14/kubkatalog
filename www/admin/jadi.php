                    ...
                    <section class="content">
                      <div class="container-fluid">
                              ...
                              <div class="card-body">
                                ...
                                <!-- <div class="row text-center">
                                        <form action="" method="post">
                                            ...
                                            <button type="submit" class="mdi mdi-search-web" name="cari"></button>
                                        </form>             
                                  </div>  -->
                        ...
                        $ambil = $koneksi->query("SELECT * FROM pembelian JOIN pembeli 
                                      ...
                                      WHERE pembelian.id_pembelian ORDER BY id_pembelian DESC LIMIT $awalData, $jumlahDataPerHalaman"); ?>
                        <?php
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <?php if ($pecah['status_pembelian'] === "Pending"): ?>
                                            <span class="badge bg-warning text-dark"><?php echo $pecah['status_pembelian']; ?></span>
                                          <?php else: ?>
                                            <span class="badge bg-success text-white"><?php echo $pecah['status_pembelian']; ?></span>
                                          <?php endif; ?>
                                          <?php if ($pecah['have_seen'] === '0' && $pecah['status_pembelian'] === "Pending"): ?>
                                            <span class="badge bg-primary text-white" id="new-button-<?php echo $pecah['id_pembelian']; ?>">New</span>
                                          <?php endif; ?>
                                        </td>
                                        <td>Rp. <?php echo number_format($pecah['finaltotalbelanjabeli']); ?></td>
                                        <td>
                                          <a href="detailpembelian.php?id=<?php echo $pecah['id_pembelian']; ?>" class="btn btn-sm btn-primary detail-button" title="Detail Pembelian"><i class="mdi mdi-eye"></i></a>&nbsp;
   ...
   <script>
      $(document).ready(function() {
        $(".detail-button").click(function() {
           $("#new-button-<?php echo $pecah['id_pembelian']; ?>").hide();
           $(this).siblings(".new-button").hide();        });
      });
    </script>
</body>
