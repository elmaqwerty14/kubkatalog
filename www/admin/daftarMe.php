                ...
                <div class="content-wrapper">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="tambah_menu.php" class="btn btn-sm btn-success"><i class="fa fa-plus" title="Tambah Menu"></i>&nbsp;Tambah Menu</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a href="edit_menu.php" class="btn btn-sm btn-gradient-primary" data-toggle="modal" data-target="#ModalUbah<?php echo $pecah['id_menu']; ?>" title="Ubah"><i class="mdi mdi-eyedropper"></i></a>  -->
                                                    ...
                                                    <a href="edit_menu.php?id=<?php echo $pecah ['id_menu']; ?>" class="btn btn-sm btn-gradient-primary" title="Edit"><i class="mdi mdi-eyedropper"></i></a>
                                                </td>
