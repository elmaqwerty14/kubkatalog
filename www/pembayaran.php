            ...
            <div class="col-md-5 mx-2 my-2 pb-2">
                ...
                <form action="" method="POST" class="pt-4 pb-4" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control input-field" value="<?php echo $detpem["finaltotalbelanjabeli"]; ?>" placeholder="Masukan Total Pembayaran" readonly style="cursor: no-drop; background-color: #FFF;" name="total" required>
                    </div>
                    <div class="form-group mb-3">
                        <i class="fa-solid fa-camera icon"></i>
                        <input type="file" class="form-control input-field" required name="bukti" accept="image/*">
                    </div>
